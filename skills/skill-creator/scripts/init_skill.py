...
SKILL_TEMPLATE = """---
name: {skill_name}
description: [TODO: Complete and informative explanation of what the skill does and when to use it. Include WHAT it does, WHEN to use it (specific triggers), and KEYWORDS users might say.]
---
...
[TODO: Add content here. Common patterns:
...
### scripts/
Executable code (Python/Bash/etc.) for automation and processing.
...
def init_skill(skill_name, path):
    ...
    try:
        ...
        example_asset.write_text("Placeholder for assets (templates, images, fonts, etc.)")
...
def main():
    if len(sys.argv) < 4 or '--path' not in sys.argv:
        ...
        print("\nExamples:")
        print("  init_skill.py my-api-skill --path ./skills")
        print("  init_skill.py brand-guidelines --path /custom/path")
        sys.exit(1)
